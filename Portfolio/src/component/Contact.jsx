...
const Contact = () => {
  ...
  try{
await axios.post("https://getform.io/f/bxoonyqa",userInfo);
        ...
        <div className='flex flex-col md:flex-row justify-between '>
            <div className='md:w-1/2 mb-8 ml-2 md:mb-0'>
              ...
              <div className='flex space-x-4'>
                <a href="https://www.facebook.com/profile.php?id=100023293359324" className='text-foreground/60 hover:text-foreground/80'>
                <img src={facebook} alt="" className='h-6 w-6'/></a>
                <a href="https://www.instagram.com/as_ajit31/" className='text-foreground/60 hover:text-foreground/80'>
                <img src={instagram} alt="" className='h-6 w-6'/></a>
                <a href="https://www.linkedin.com/in/ajit-kumar-74074331b/" className='text-foreground/60 hover:text-foreground/80'>
